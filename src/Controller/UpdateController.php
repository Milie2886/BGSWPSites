...
class UpdateController extends AbstractController
{
     ...
     */
    //Définition de la route "test" appelée par un bouton qui effectue la mise à jour pour tous les sites
    public function test(HttpClientInterface $httpClient, TypesRepository $typesRepository, SiteRepository $siteRepository ): Response 
    {
        //Récupération des sites
        $actualComp = $typesRepository->findByName();
        dd($actualComp);
        $sites = $siteRepository->findBy([], ['name' => 'ASC']);
        // Pour chaque site présent dans la base, on veut récupérer le champs "url" et le mettre dans une variable
        foreach($sites as $site) {
