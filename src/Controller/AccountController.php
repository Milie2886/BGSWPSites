...
class AccountController extends AbstractController
{
    ...
    {
        $user = $this->getUser();
        //on va utiliser le meme formulaire que celui utilisé lors de la réinitialisation
        $form = $this->createForm(ChangePasswordFormType::class, null, [
            //On active le champs 'current password' pour ce controller. 
            //Pour le controller ResetPassword, il sera mis à False (option définie dans le formType)
